 ...
 * 
 */
@WebServiceClient(name = "TeamsService", targetNamespace = "http://team.chapterOne/", wsdlLocation = "http://localhost:8888/teams?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEAMSSERVICE_QNAME = new QName("http://team.chapterOne/", "TeamsService");
    ...
    public Teams getTeamsPort() {
        return super.getPort(new QName("http://team.chapterOne/", "TeamsPort"), Teams.class);
    }
    ...
    public Teams getTeamsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://team.chapterOne/", "TeamsPort"), Teams.class, features);
    }
