 ...
 * generated in the chapterOne.team.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetTeam_QNAME = new QName("http://team.chapterOne/", "getTeam");
    private final static QName _GetTeams_QNAME = new QName("http://team.chapterOne/", "getTeams");
    private final static QName _GetTeamsResponse_QNAME = new QName("http://team.chapterOne/", "getTeamsResponse");
    private final static QName _GetTeamResponse_QNAME = new QName("http://team.chapterOne/", "getTeamResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: chapterOne.team.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.chapterOne/", name = "getTeam")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.chapterOne/", name = "getTeams")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.chapterOne/", name = "getTeamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.chapterOne/", name = "getTeamResponse")
