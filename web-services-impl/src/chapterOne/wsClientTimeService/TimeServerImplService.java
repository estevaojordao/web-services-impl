...
package chapterOne.wsClientTimeService;
 ...
 * 
 */
@WebServiceClient(name = "TimeServerImplService", targetNamespace = "http://example.chapterOne/", wsdlLocation = "http://localhost:9876/ts?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TIMESERVERIMPLSERVICE_QNAME = new QName("http://example.chapterOne/", "TimeServerImplService");
    ...
    public TimeServer getTimeServerImplPort() {
        return super.getPort(new QName("http://example.chapterOne/", "TimeServerImplPort"), TimeServer.class);
    }
    ...
    public TimeServer getTimeServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.chapterOne/", "TimeServerImplPort"), TimeServer.class, features);
    }
